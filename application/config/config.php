...
|
*/
$config['base_url'] = getenv('APP_URL') ?: 'http://localhost/check_virtual_try-on_E-comm_app/';
...
|
*/
$config['encryption_key'] = getenv('APP_KEY') ?: 'change-this-virtual-atelier-key-in-production';
...
$config['sess_cookie_name'] = 'atelier_session';
...
$config['csrf_token_name'] = 'atelier_csrf';
$config['csrf_cookie_name'] = 'atelier_csrf_cookie';
